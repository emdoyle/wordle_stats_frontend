...
const TermsOfService = () => {
  return (
    <Layout termsOfService={false}>
      ...
      <ul>
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Wordle
            Stats
          </p>
        </li>
        <li>
          <p>
            ...
            service operated and developed by Slack Technologies, LLC (Slack App
            Directory) in which the Application has been downloaded.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: support@0x63problems.dev</li>
      </ul>
    </Layout>
  );
};
