...
const PrivacyPolicy = () => {
  return (
    <Layout privacyPolicy={false}>
      ...
      <p>
        The Company allows You to use the Service through the following
      ...
      <p>
        ...
        Third-Party Social Media Service's account, such as Your name or Your
      ...
      <ul>
        <li>
          <p>By email: support@0x63problems.dev</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://wordle.0x63problems.dev/support"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://wordle.0x63problems.dev/support
            </a>
          </p>
        </li>
      </ul>
